package com.marzman232.ipp.common.compat.jei;
...
public class MusicalInstrumentCategory implements IRecipeCategory<MusicalInstrumentShadowRecipe> {
	...
	public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(MODID, "musical_instrument");
	public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/musical_instrument.png");
